...
public class NetAlbumsAdapter extends RecyclerView.Adapter<NetAlbumsAdapter.MyViewHolder> {

    public final List<Album> albumList;
    public final AlbumSelectListener listener;

    public NetAlbumsAdapter(List<Album> albums, AlbumSelectListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_net_albums, parent, false);
